...
using System.Windows.Forms;//¥Windows¥Microsoft.NET¥assembly¥GAC_MSIL

namespace WebAppForGenerateImage.Helpers
{
    public class WebsiteThumbnailImageHelper
    {
        ...
        public static bool GetWebSiteThumbnailAndSave(string Url, string file_path, int ThumbnailWidth, int ThumbnailHeight)
        {
            try
            {
        ...
        {
            public WebsiteThumbnailImage(string Url, int ThumbnailWidth, int ThumbnailHeight)
            {
                this.m_Url = Url;
            ...
            private int m_BrowserWidth = 1024;
            ...
            private int m_BrowserHeight = 768;
            ...
            private void WebBrowser_DocumentCompleted(object sender, WebBrowserDocumentCompletedEventArgs e)
            {
                ...
                m_WebBrowser.ScrollBarsEnabled = false;
                using (m_Bitmap = new Bitmap(m_WebBrowser.Bounds.Width, m_WebBrowser.Bounds.Height))
                {
